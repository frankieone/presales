...
function parseCsv(text: string): CsvEntity[] {
  ...
  const idIdx = headerCols.findIndex((h) => h === 'Entity ID');
  const typeIdx = headerCols.findIndex((h) => h === 'Entity Type');
  const nameIdx = headerCols.findIndex((h) => h === 'Organisation Name');
