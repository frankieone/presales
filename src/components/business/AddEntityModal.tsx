      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => { setEntityType('INDIVIDUAL'); setRoleCode(''); }}
            ...
            <button
              type="button"
              onClick={() => { setEntityType('ORGANIZATION'); setRoleCode('SH'); }}
              className={`flex-1 py-2 text-sm font-medium rounded-lg border transition-colors ${
          ...
          {/* Role — only shown for individuals; orgs default to Shareholder */}
          {entityType === 'INDIVIDUAL' && (
            <Select
              id="role"
              label="Role"
